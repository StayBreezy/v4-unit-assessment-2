...
//CODE HERE
  let phone1 = new Phone('nokia', 'brick', 5, 'green', false);

  let phone2 = new Phone('apple', 'i5', 6, 'fucia', false);

  let phone3 = new Phone('bb', 'the one with the scrolly buddy', 10, 'black', false)
